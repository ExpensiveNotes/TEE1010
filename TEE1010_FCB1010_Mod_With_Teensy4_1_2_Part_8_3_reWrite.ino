...
const char pedalModeNames[numModes][4] = {"Nul", "Syn", "Lat", "Arp", "P", "PE", "S", "SE", "SOS", "Mix", "MID", "M?", "MEd", "Sys"}; // Char array number of strings then size of each string
...
char menuModes[12][5] = {"Syn", "Lat", "Arp", "Patt", "PEd", "Song", "SEd", "Son?", "Mix", "MIDc", "MIDe", "Sys"};
...
void interfaceMode() {
  ...
  switch (pedalMode) {
    ...
    case MIDIControllerEditMode:
      //To do
      Serial.println("MIDIControllerEditMode");
      showMode();
      break;
...
void changePedalModeUsingMenu() {
  int value = checkMenu(menuModes, 12, menuModesTitle);
  if (value != -1) {
    pedalMode = value + 1;
  }
}
